...
if(($_SESSION['login'] == 1)) 
		{
			if($_SESSION['username'] == 'admin')
			{
				...
				echo '<table>';
				echo '<tr>';
				echo '<th>請輸入要檢視的顧客序號:</th>';
				echo '</tr>';
				
					
					echo '<form method="post" action="./cart_view_pay_single.php" >';
					echo '<tr>';
						echo '<td>';
						echo '輸入顧客序號:<input type="text" name="pay_single"  style = "height:30px; width:50px"/>';
	...
	{
		$_SESSION['view_pay_single']= 'cart_pay_single_input.php';
		require_once('cart_contact_login_input.php');
	} 				
